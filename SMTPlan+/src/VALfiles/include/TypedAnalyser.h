...
namespace VAL
{
    ...
    class SimplePropStore : public PropStore
    {
      ...
      public:
        SimplePropStore()
            : ep(0){};
        SimplePropStore(extended_pred_symbol* e)
            : ep(e){};
...
*/
    ...
    struct OpProp
    {
        ...
        OpProp(operator_* o, const proposition* p)
            : op(o), drv(0), second(p){};
...
*/
        ...
        void write(ostream& o) const
        {
            ...
            o << "\n------------\nInitial: " << initialState
              << " Goal: " << posgoalState << " positive/ " << neggoalState << " negative\nInitial state records:\n";
            records()->write(o);
            o << "\nPreconditions:\n";
    ...
    class holding_pred_symbol : public pred_symbol
    {
      ...
      public:
        holding_pred_symbol(const string& nm)
            : pred_symbol(nm), a(new NodeAssociater()),
...
#define HPS(x) const_cast<VAL::holding_pred_symbol*>(static_cast<const VAL::holding_pred_symbol*>(x))
    ...
    class Analyser : public VisitController
    {
      ...
      public:
        Analyser()
            : initially(false), when(0), finally(false),
