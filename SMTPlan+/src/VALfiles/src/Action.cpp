...
namespace VAL
{
        ...
        const State* s, const effect_lists* effs, const Environment& bds, bool markPreCons) const
    {
        ...
        for (list<cond_effect*>::const_iterator i2 = effs->cond_effects.begin();
            ...
            if (p->evaluate(s)) {
                ...
                if ((markPreCons && !p->markOwnedPreconditions(this, o)) || !handleEffects(o, e, s, (*i2)->getEffects(), bds, markPreCons)) {
                    p->destroy();
                    if (Verbose)
    ...
    struct ContextAdder
    {
        ...
        ContextAdder(ExecutionContext& e)
            : ec(e){};
    ...
    struct ContextRemover
    {
        ...
        ContextRemover(ExecutionContext& e)
            : ec(e){};
