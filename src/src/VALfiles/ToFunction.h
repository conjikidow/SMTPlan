...
namespace SAS
{
    ...
    class VarElement : public VElement
    {
      ...
      public:
        VarElement(const parameter_symbol* v)
            : var(v){};
        void write(ostream& o) const
        {
    ...
    class WildElement : public VElement
    {
      ...
      public:
        WildElement(const ValuesUnion& v)
            : id(idgen++), var(v){};
        void write(ostream& o) const
        {
            int u = var.size();
    ...
    class PlaceHolderElement : public VElement
    {
      ...
      public:
        PlaceHolderElement(const PlaceHolder* p)
            : ph(p){};
        void write(ostream& o) const
        {
            o << *ph;
