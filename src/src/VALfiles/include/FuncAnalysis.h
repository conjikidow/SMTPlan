...
namespace VAL
{
    ...
    class FValue
    {
      ...
      public:
        FValue()
            : fve(E_POSITIVE), isConst(false){};
        FValue(FValueEnum e)
            : fve(e), isConst(false){};
        FValue(int e)
            : fve((FValueEnum)(e)), isConst(false){};
        FValue(const FValue& f)
            : fve(f.fve), isConst(f.isConst){};
    ...
    class FuncGatherer : public VisitController
    {
      ...
      public:
        FuncGatherer(extended_func_symbol* e)
            : eft(e), cont(false){};
      ...
      public:
        ...
        pair<bool, double> getInitial(const TI t1, const TI) const
        {
            ...
            for (; i != iEnd; ++i) {
                ...
                if (j == jEnd) {
                    return make_pair(true, dynamic_cast<const num_expression*>((*i)->getExpr())->double_value());
                };
            };
