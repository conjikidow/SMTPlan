    ...
    class PNE
    {
      ...
      public:
        ...
        struct PNEParametersOutput : unary_function<const VAL::parameter_symbol*, string>
        {
            ...
            PNEParametersOutput(const VAL::FastEnvironment& bs)
                : bindings(bs){};
    ...
    class Literal
    {
      ...
      public:
        ...
        struct LiteralParametersOutput
        {
            ...
            LiteralParametersOutput(const VAL::FastEnvironment& bs)
                : bindings(bs){};
            string operator()(const VAL::parameter_symbol* v) const
            {
                return bindings[v]->getName();
    ...
    class instantiatedOp
    {
      private:
        ...
        struct ActionParametersOutput
        {
            ...
            ActionParametersOutput(const VAL::FastEnvironment& bs)
                : bindings(bs){};
      ...
      public:
        ...
        class PNEEffectsIterator
        {
          ...
          public:
            ...
            {
                return effts == i.effts && (effs == i.effs || (effts == efftsend && effs == effsend && i.effs == i.effsend));
            };
            bool operator!=(const PNEEffectsIterator& i) const
            {
                return !(*this == i);
