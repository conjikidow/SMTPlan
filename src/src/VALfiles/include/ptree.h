...
namespace VAL
{
    ...
    enum quantifier { E_FORALL,
        E_EXISTS };
    enum polarity { E_NEG,
        E_POS };
    enum assign_op { E_ASSIGN,
        E_INCREASE,
        E_DECREASE,
        E_SCALE_UP,
        E_SCALE_DOWN,
        E_ASSIGN_CTS };
    enum comparison_op { E_GREATER,
        E_GREATEQ,
        E_LESS,
        E_LESSEQ,
        E_EQUALS };
    enum optimization { E_MINIMIZE,
        E_MAXIMIZE };
    enum time_spec { E_AT_START,
        E_AT_END,
        E_OVER_ALL,
        E_CONTINUOUS,
        E_AT };
    enum special_val { E_HASHT,
        E_DURATION_VAR,
        E_TOTAL_TIME };
    enum length_mode { E_SERIAL,
        E_PARALLEL,
        E_BOTH };
    enum constraint_sort { E_ATEND,
        E_ALWAYS,
        E_SOMETIME,
        E_WITHIN,
        E_ATMOSTONCE,
 ...
 *-------------------------------------------------------------------------*/
    ...
    class structure_store : public parse_category
    {
      ...
      public:
        structure_store()
            : ops(new operator_list), dvs(new derivations_list), cs(new classes_list){};
