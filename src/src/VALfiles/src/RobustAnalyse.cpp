...
*/
    ...
    void RobustPlanAnalyser::analyseRobustness()
    {
        ...
        if (!calcActionRobustness && !calcPNERobustness)
            runAnalysis(robustMeasure, noTestPlans, true, numberOfInvalidPlans, numberOfErrorPlans, false, latex);
        ...
        if (LaTeX)
            displayAnalysisLaTeX(noTestPlans, numberOfInvalidPlans, numberOfErrorPlans, actionRobustnessOfPlan, actionRobustnessBound, pneRobustnessOfPlan, pneRobustnessBound);
        else
            displayAnalysis(noTestPlans, numberOfInvalidPlans, numberOfErrorPlans, actionRobustnessOfPlan, actionRobustnessBound, pneRobustnessOfPlan, pneRobustnessBound);
    };
        ...
        *report << "\n";
        ...
        if (Verbose && numberOfInvalidPlans != 0) {
            ...
            if (numberOfErrorPlans == 1)
                ...
                cout << numberOfErrorPlans << " plans did not execute due errors in the validation process.\n";
        ...
        if (!calcActionRobustness && !calcPNERobustness) {
            *report << "\\item ";
            if (noTestPlans - numberOfErrorPlans - numberOfInvalidPlans == 1)
                ...
                *report << noTestPlans - numberOfErrorPlans - numberOfInvalidPlans << " plans are valid from ";
        ...
        if (numberOfInvalidPlans != 0) {
            ...
            *report << "\\begin{tabbing}\n {\\bf Failures} \\= {\\bf Time} \\qquad \\= {\\bf Action}\\\\[0.8ex]\n";
            ...
            if (unsatisfiedGoal == 1)
                ...
                *report << unsatisfiedGoal << " \\> \\> Plans failed because the goal is not satisfied.\\\\\n";
            ...
            if (numberOfErrorPlans == 1)
                ...
                *report << numberOfErrorPlans << "  \\> \\> plans did not execute due errors in the validation process.\\\\\n";
