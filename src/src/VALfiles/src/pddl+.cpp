...
#line 299 "src/pddl+.yacc"
        {
            (yyval.t_class) = current_analysis->classes_tab.symbol_get((yyvsp[(1) - (1)].cp));
            delete[](yyvsp[(1) - (1)].cp);
            ;
        } break;
...
#line 522 "src/pddl+.yacc"
        {
            (yyval.t_const_symbol) = current_analysis->const_tab.new_symbol_put((yyvsp[(1) - (1)].cp));
            delete[](yyvsp[(1) - (1)].cp);
            ;
        } break;
...
#line 647 "src/pddl+.yacc"
        {
            (yyval.t_effect_lists) = new effect_lists;
            (yyval.t_effect_lists)->forall_effects.push_back(new forall_effect((yyvsp[(6) - (7)].t_effect_lists), (yyvsp[(4) - (7)].t_var_symbol_list), current_analysis->var_tab_stack.pop()));
            requires(E_COND_EFFS);
            ;
        } break;
...
#line 652 "src/pddl+.yacc"
        {
            (yyval.t_effect_lists) = new effect_lists;
            (yyval.t_effect_lists)->cond_effects.push_back(new cond_effect((yyvsp[(3) - (5)].t_goal), (yyvsp[(4) - (5)].t_effect_lists)));
            requires(E_COND_EFFS);
            ;
        } break;
...
#line 657 "src/pddl+.yacc"
        {
            (yyval.t_effect_lists) = new effect_lists;
            (yyval.t_effect_lists)->cond_assign_effects.push_back(new cond_effect((yyvsp[(3) - (5)].t_goal), (yyvsp[(4) - (5)].t_effect_lists)));
            requires(E_COND_EFFS);
            ;
        } break;
...
#line 681 "src/pddl+.yacc"
        {
            ...
            (yyval.t_timed_effect)->effs->assign_effects.push_front(new assignment((yyvsp[(3) - (5)].t_func_term), E_INCREASE, (yyvsp[(4) - (5)].t_expression)));
            ;
        } break;
...
#line 685 "src/pddl+.yacc"
        {
            (yyval.t_timed_effect) = new timed_effect(new effect_lists, E_CONTINUOUS);
            (yyval.t_timed_effect)->effs->assign_effects.push_front(new assignment((yyvsp[(3) - (5)].t_func_term), E_DECREASE, (yyvsp[(4) - (5)].t_expression)));
            ;
        } break;
...
#line 816 "src/pddl+.yacc"
        {
            (yyval.t_goal) = new timed_goal(new comparison((yyvsp[(2) - (6)].t_comparison_op),
                                                new special_val_expr(E_DURATION_VAR), (yyvsp[(5) - (6)].t_expression)),
                E_AT_START);
            ;
        } break;
...
#line 819 "src/pddl+.yacc"
        {
            (yyval.t_goal) = new timed_goal(new comparison((yyvsp[(4) - (9)].t_comparison_op),
                                                new special_val_expr(E_DURATION_VAR), (yyvsp[(7) - (9)].t_expression)),
                E_AT_START);
            ;
        } break;
...
#line 923 "src/pddl+.yacc"
        {
            (yyval.t_func_term) = new func_term(current_analysis->func_tab.symbol_get((yyvsp[(2) - (4)].cp)), (yyvsp[(3) - (4)].t_parameter_symbol_list));
            delete[](yyvsp[(2) - (4)].cp);
            ;
        } break;
...
#line 931 "src/pddl+.yacc"
        {
            (yyval.t_func_term) = new class_func_term((yyvsp[(2) - (6)].t_class), current_analysis->func_tab.symbol_get((yyvsp[(4) - (6)].cp)), (yyvsp[(5) - (6)].t_parameter_symbol_list));
            delete[](yyvsp[(4) - (6)].cp);
            ;
        } break;
...
#line 1056 "src/pddl+.yacc"
        {
            (yyval.t_con_goal) = new constraint_goal(E_WITHIN, (yyvsp[(4) - (5)].t_goal), NULL, (yyvsp[(3) - (5)].t_num_expression)->double_value(), 0.0);
...
#line 1064 "src/pddl+.yacc"
        {
            (yyval.t_con_goal) = new constraint_goal(E_ALWAYSWITHIN, (yyvsp[(5) - (6)].t_goal), (yyvsp[(4) - (6)].t_goal), (yyvsp[(3) - (6)].t_num_expression)->double_value(), 0.0);
...
#line 1066 "src/pddl+.yacc"
        {
            (yyval.t_con_goal) = new constraint_goal(E_HOLDDURING, (yyvsp[(5) - (6)].t_goal), NULL, (yyvsp[(4) - (6)].t_num_expression)->double_value(), (yyvsp[(3) - (6)].t_num_expression)->double_value());
            delete (yyvsp[(3) - (6)].t_num_expression);
...
#line 1068 "src/pddl+.yacc"
        {
            (yyval.t_con_goal) = new constraint_goal(E_HOLDAFTER, (yyvsp[(4) - (5)].t_goal), NULL, 0.0, (yyvsp[(3) - (5)].t_num_expression)->double_value());
            delete (yyvsp[(3) - (5)].t_num_expression);
            ;
        } break;
...
#line 1192 "src/pddl+.yacc"
        {
            (yyval.t_structure_def) = (yyvsp[(1) - (1)].t_class_def);
            requires(E_MODULES);
            ;
        } break;
...
#line 1349 "src/pddl+.yacc"
        {
            (yyval.t_pddl_req_flag) = E_TIME | E_NFLUENTS | E_DURATIVE_ACTIONS;
            ;
        } break;
...
#line 1424 "src/pddl+.yacc"
        {
            (yyval.t_problem) = (yyvsp[(2) - (2)].t_problem);
            if ((yyval.t_problem)->metric == 0) {
                (yyval.t_problem)->metric = (yyvsp[(1) - (2)].t_metric);
            } else {
                (yyval.t_problem)->metric->add((yyvsp[(1) - (2)].t_metric));
            };
        } break;
